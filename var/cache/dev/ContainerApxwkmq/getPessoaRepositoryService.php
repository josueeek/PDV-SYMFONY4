...
// Returns the private 'App\Repository\PessoaRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/PessoaRepository.php';

return $this->services['App\Repository\PessoaRepository'] = new \App\Repository\PessoaRepository(${($_ = isset($this->services['doctrine']) ? $this->services['doctrine'] : $this->getDoctrineService()) && false ?: '_'});
