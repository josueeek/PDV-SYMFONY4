...
// Returns the private 'App\Repository\ItemPedidoRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ItemPedidoRepository.php';

return $this->services['App\Repository\ItemPedidoRepository'] = new \App\Repository\ItemPedidoRepository(${($_ = isset($this->services['doctrine']) ? $this->services['doctrine'] : $this->getDoctrineService()) && false ?: '_'});
