...
// Returns the private 'App\Repository\PedidoRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/PedidoRepository.php';

return $this->services['App\Repository\PedidoRepository'] = new \App\Repository\PedidoRepository(${($_ = isset($this->services['doctrine']) ? $this->services['doctrine'] : $this->getDoctrineService()) && false ?: '_'});
