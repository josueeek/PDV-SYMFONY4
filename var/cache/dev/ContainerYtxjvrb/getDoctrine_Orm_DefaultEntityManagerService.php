...
$b->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\ItemPedidoRepository' => function () {
    return ${($_ = isset($this->services['App\Repository\ItemPedidoRepository']) ? $this->services['App\Repository\ItemPedidoRepository'] : $this->load(__DIR__.'/getItemPedidoRepositoryService.php')) && false ?: '_'};
}, 'App\\Repository\\PedidoRepository' => function () {
    return ${($_ = isset($this->services['App\Repository\PedidoRepository']) ? $this->services['App\Repository\PedidoRepository'] : $this->load(__DIR__.'/getPedidoRepositoryService.php')) && false ?: '_'};
}, 'App\\Repository\\PessoaRepository' => function () {
    return ${($_ = isset($this->services['App\Repository\PessoaRepository']) ? $this->services['App\Repository\PessoaRepository'] : $this->load(__DIR__.'/getPessoaRepositoryService.php')) && false ?: '_'};
}, 'App\\Repository\\ProdutoRepository' => function () {
    return ${($_ = isset($this->services['App\Repository\ProdutoRepository']) ? $this->services['App\Repository\ProdutoRepository'] : $this->load(__DIR__.'/getProdutoRepositoryService.php')) && false ?: '_'};
}))));
