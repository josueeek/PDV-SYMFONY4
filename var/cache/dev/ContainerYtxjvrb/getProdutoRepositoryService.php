...
// Returns the private 'App\Repository\ProdutoRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ProdutoRepository.php';

return $this->services['App\Repository\ProdutoRepository'] = new \App\Repository\ProdutoRepository(${($_ = isset($this->services['doctrine']) ? $this->services['doctrine'] : $this->getDoctrineService()) && false ?: '_'});
